...
var g$2 = b$1 ? Symbol.for("react.profiler") : 60114;
...
var q$2 = b$1 ? Symbol.for("react.suspense_list") : 60120;
...
var P = Boolean(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process != "undefined" && {}.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && {}.REACT_APP_SC_DISABLE_SPEEDY !== "" ? {}.REACT_APP_SC_DISABLE_SPEEDY : typeof process != "undefined" && {}.SC_DISABLE_SPEEDY !== void 0 && {}.SC_DISABLE_SPEEDY !== "" ? {}.SC_DISABLE_SPEEDY : false);
var O = {};
function j(e2) {
...
var ae = [":", "[", ".", "#"];
function ce(e2) {
  var t2, n2, r2, o, s = e2 === void 0 ? E : e2, i = s.options, a = i === void 0 ? E : i, c2 = s.plugins, u = c2 === void 0 ? w : c2, l2 = new stylis_min(a), d2 = [], h = /* @__PURE__ */ function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
...
function qe(e2, t2, n2) {
  ...
  var C, I2 = new se(n2, g2, o ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(Re(t4, (0, import_react.useContext)(Le), a2) || E, t4, o2), y2 = f3[0], g3 = f3[1], S3 = function(e5, t5, n4, r3) {
      ...
      return t4.style && g3.style !== t4.style && (C2.style = v({}, t4.style, {}, g3.style)), C2.className = Array.prototype.concat(c3, h2, S3 !== h2 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, (0, import_react.createElement)(_2, C2);
    }(C, e3, t3, P2);
  };
  return O2.displayName = f2, (C = import_react.default.forwardRef(O2)).attrs = S2, C.componentStyle = I2, C.displayName = f2, C.shouldForwardProp = A2, C.foldedComponentIds = o ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w, C.styledComponentId = g2, C.target = o ? e2.target : e2, C.withComponent = function(e3) {
...
function We(e2) {
  ...
  function l2(e3) {
    var t3 = fe(), n3 = me(), o2 = (0, import_react.useContext)(Le), l3 = (0, import_react.useRef)(t3.allocateGSInstance(a)).current;
    return t3.server && h(l3, e3, t3, o2, n3), (0, import_react.useLayoutEffect)(function() {
      if (!t3.server)
...
var useOutsideClick = (ref, setDropdownVisibility, setValue) => {
...
var StyledIconContainer = styled.span`
  ...
  align-items: center;
`;
var StyledInputContainer = styled.span`
  position: relative;
`;
var Input = ({
  placeholder,
  ...
  const leftIconNode = () => {
    ...
    return jsx(StyledIconContainer, {
      iconBoxSize,
      inputHeight,
      children: leftIcon
    });
  };
  return jsxs(StyledInputContainer, {
...
var ReactSearchBox = ({
  ...
  const [matchedRecords, setMatchedRecords] = (0, import_react.useState)([]);
  const [value, setValue] = (0, import_react.useState)("");
  const [showDropdown, setDropdownVisibility] = (0, import_react.useState)(false);
  ...
  return jsx("div", {
    ...
    children: jsxs(StyledContainer, {
      children: [jsx(GlobalStyle, {}), inputNode(), dropdownNode()]
    })
  });
};
export {
  ReactSearchBox as default
};
